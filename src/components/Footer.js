                ...
                <div className="copyright">
                    <div className="row">
                        <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a className="border-bottom" href=" ">NIPS SERVICE</a>, All Right Reserved.
                            Designed By <a className="border-bottom" href="https://www.linkedin.com/in/viktor-stefanov-953047263">Viktor Stefanov</a>
                        </div>
                    </div>
                </div>
            </div>
